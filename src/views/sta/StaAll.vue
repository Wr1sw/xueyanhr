<template>
  <div>
    ...
    <div class="dom_choice">
      ...
      <div class="choice"><el-button type="success" icon="el-icon-s-promotion" plain @click="onClick('politicStatus')">政治信息</el-button></div>
      <div class="choice"><el-button type="success" icon="el-icon-s-promotion" plain @click="onClick('birthYear')">年龄信息</el-button></div>
      <div class="choice"><el-button type="success" icon="el-icon-s-promotion" plain @click="onClick('wedlock')">婚姻状况</el-button></div>
      <div class="choice"><el-button type="success" icon="el-icon-s-promotion" plain @click="onClick('gender')">性别信息</el-button></div>
    </div>
  </div>
</template>
