<template>
  <div>
    ...
    <el-table :data="tableData" style="width: 100%" class="el-table__body-wrapper">
      ...
      <el-table-column prop="beforejobName" label="调动前职称"></el-table-column>
      ...
      <el-table-column prop="afterjobName" label="调动后职称"></el-table-column>
      <el-table-column prop="afterposName" label="调动后职位"></el-table-column>

      <el-table-column prop="removedate" label="调动日期"></el-table-column>
