        ...
        methods: {
            deleteMany() {
                this.$confirm('此操作将永久删除【' + this.multipleSelection.length + '】条记录, 是否继续?', '提示', {
                    ...
                    this.deleteRequest("/system/cfg/joblevel/" + ids).then(resp => {
                        if (resp) {
                            this.initJls();
                        }
                    })
            ...
            deleteHandler(data) {
                this.$confirm('此操作将永久【' + data.name + '】职称, 是否继续?', '提示', {
                    ...
                    this.deleteRequest("/system/cfg/joblevel/" + data.id).then(resp => {
                        if (resp) {
                            this.initJls();
                        }
                    })
            ...
            addJobLevel() {
                ...
                if (this.jl.name && this.jl.titlelevel) {
                    console.log(this.jl)
                    this.postRequest("/system/cfg/joblevel/", this.jl).then(resp => {
                        if (resp) {
                            this.initJls();
                        }
                    });
            ...
            initJls() {
                this.loading = true;
                this.getRequest("/system/cfg/joblevel/").then(resp => {
                    this.loading = false;
